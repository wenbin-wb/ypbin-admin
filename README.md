...
| 任务调度 | 商业授权 |
|---|---|
| ![任务调度](https://ypbin.cn/screenshots/admin-ui/jobs.png) | ![商业授权](https://ypbin.cn/screenshots/admin-ui/licenses.png) |

| 登录入口 | AI 对话（截图待补） |
|---|---|
| ![登录入口](https://ypbin.cn/screenshots/admin-ui/login.png) | *AI 对话界面截图即将补充* |
