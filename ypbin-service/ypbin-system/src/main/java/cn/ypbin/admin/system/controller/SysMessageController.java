...
public class SysMessageController {
    ...
    public R<PageResult<MessageResp>> list(@Valid MessageQuery query) {
        return R.ok(messageService.pageMessages(currentUserId(), query));
    }
    ...
    public R<Long> unreadCount() {
        return R.ok(messageService.unreadCount(currentUserId()));
    }
    ...
    public R<List<MessageResp>> recent(
        ...
        return R.ok(messageService.recent(currentUserId(), limit));
    }
    ...
    private Long currentUserId() {
        return IdentityContext.getUserId().orElse(null);
    }
}
